# Spring PetClinic Sample Application [![Build Status](https://travis-ci.org/jdiatte/spring-petclinic.svg?branch=master)](https://travis-ci.org/github/jdiatte/spring-petclinic)
