# Spring PetClinic Sample Application [![Build Status](https://travis-ci.org/github/jdiatte/spring-petclinic.png?branch=master)](https://travis-ci.org/github/jdiatte/spring-petclinic)
